...
// Implement the code
        ...
        // Iterate over each record and split it by ","
        // Print the productId for each record
        // This will give you the product IDs in the given dataset.
        String[] recordArray = records.split(":");
        // Print each record
        for (String record : recordArray) {
//            System.out.println(record);
            String[] recordArrayArr = record.split(",");
            System.out.println("\t" + recordArrayArr[0]);
        }
    }
}
